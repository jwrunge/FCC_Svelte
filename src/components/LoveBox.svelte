...
<div class="love-box">
	<img
		bind:this={loveImage}
		class="bg"
		src="/primary-images/hearts.svg"
		alt=""
		style={"transform: translateY(-15%) translateY(" + loveTop / 5 + "px);"}
	/>

	<div class="inner">
		<h2>We love our church!</h2>
		<p>
			We asked our church family to name a few of the things they love
			about First Christian Church, and they delivered!
		</p>
		<div class="phrases">
			{#await getPhrases("data/php/getLovePhrases.php")}
				<div class="loader">
