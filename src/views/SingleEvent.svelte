			...
			{:then events}
				...
				{:then sortedEvents}
					...
					{#if sortedEvents[eventIndex].img}
						<img
							class="sm-bottom-margin"
							src={sortedEvents[eventIndex].img.src}
							alt={sortedEvents[eventIndex].img.alt}
						/>
					{/if}
					<div class="event-details">
						...
						<span
							><strong>Where:</strong>
							{sortedEvents[eventIndex].location}</span
						>
					</div>
