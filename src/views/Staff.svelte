<script>
    ...
    let staffers = [
        ...
        { name: 'Lorraine Stone', title: "Office Manager", emails: ["fccgalesburg@gmail.com"], src: '/staff-photos/lorraine.jpg', bio: "<p>Lorraine was raised in Knoxville and graduated from Knoxville High School. She earned an associates in administrative secretarial degree from Carl Sandburg College. She says, \"God has blessed me with a loving husband, three wonderful children, and an amazing grandson. I enjoy reading, cross-stitch and puzzles.\"</p>"},
