<script>
    ...
    let staffers = [
        ...
        { name: 'Rachel Sutter', title: "Custodian", emails: [], src: '/staff-photos/RachelSutter.jpg', bio: "<p>I was born and raised in Galesburg and in First Christian Church. I recently married the love of my life, Matthew, and the Lord blessed me with four beautiful children and a niece, Olivia, Jacob, Ethan, Isaiah, and Megan. After serving at the Rescue Mission for the past several years, I am excited to worship while I work cleaning the building that I love for the people I love.</p>"},
